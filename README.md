...
- [x] Buy `squaregame.io`
- [ ] Generate the square data by doing one of:
  - [ ] Parsing [Munklar's](https://github.com/Munklar/Partridge-Puzzle) solution outputs (I'll send him some coffee money at some point obviously). I've started this already with [app/Main.hs](./app/Main.hs)
  - [ ] Upgrading my dlx solver to Algorithm M from Knuth's Art of Computer Programming, then generating them all myself
